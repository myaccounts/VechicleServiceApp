...
public class VehicleHistoryReport extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.vehiclehistorysearchreport_layout, container, false);
    ...
    private void filter(String text) {
        ...
        vehicleHistoryAdapter.setFilter(countryLists);
    }
        ...
        try {
            ...
            if (AppUtil.isNetworkAvailable(getActivity()))
            {
                try {
                    ...
                    serviceCall.makeJSONOArryPostRequest(ProjectVariables.BASE_URL + ProjectVariables.VehicleHistory, jsonObject, Request.Priority.HIGH);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            } else {
    ...
    private class OnServiceCallCompleteListenerUserImpl implements OnServiceCallCompleteListener {
        ...
        public void onJSONArrayResponse(JSONArray jsonArray) {
            if (requestName.equalsIgnoreCase("VehicleHistory")) {
                try {
                    pDialog.dismiss();
    ...
    private void handeServiceMasterDetails(JSONArray jsonArray) {
        try {
            ...
            mVehicleHistoryRecyclerview.setAdapter(vehicleHistoryAdapter);
