...
public class ContextMenuDialogFragment extends DialogFragment implements OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    private void initDropDownMenuAdapter() {
        ...
        mDropDownMenuAdapter.setOnItemLongClickListener(getActivity());
