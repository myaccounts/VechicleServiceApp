...
public class DownloadImageServer extends AsyncTask<Void, Void, String> {
...
//    private Uri fileUri;
    ...
    public DownloadImageServer(String image,Context context) {
//        this.f = f;
        this.image = image;
...
//        this.fileUri = fileUri;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            File mediaFile;
            mImageName = "MI_CAPTURE" + timeStamp + ".jpg";
...
//                ftp.uploadFile(targetStream, Image);
            ...
            if (status == true) {
                ...
                sessionManager.storeCaptureImage1LocalPath(mypath.getAbsolutePath());
            } else {
