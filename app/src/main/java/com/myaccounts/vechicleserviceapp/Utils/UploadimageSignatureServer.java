...
public class UploadimageSignatureServer extends AsyncTask<Void, Void, String> {
    ...
    public UploadimageSignatureServer(File f, String Image, Uri fileUri, Context context) {
        this.f = f;
        this.Image = Image;
