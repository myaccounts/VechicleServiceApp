...
public class SubServiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subservice_layout);
  ...
  /*  @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Intent intent=new Intent(SubServiceActivity.this, SparePartReceiptActivity.class);
        ...
        try{
            switch (v.getId())
            {
                ...
                case R.id.IdRightArrow:
                    Intent intent1=new Intent(SubServiceActivity.this, SparePartEstAgstCustomerActivity.class);
