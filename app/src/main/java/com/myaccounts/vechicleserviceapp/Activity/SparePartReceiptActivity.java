...
public class SparePartReceiptActivity extends AppCompatActivity implements View.OnClickListener {
    private ImageView IdRightArrow,IdLeftArrow;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        setContentView(R.layout.sparepartreceipt_layout);
...
//        menu.findItem(R.id.alltv).setTitle("");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Intent intent=new Intent(SparePartReceiptActivity.this, SubServiceActivity.class);
        ...
        try{
            switch (v.getId())
            {
                case R.id.IdLeftArrow:
                    Intent intent=new Intent(SparePartReceiptActivity.this, SparePartMasterActivity.class);
                    startActivity(intent);
                    break;
                case R.id.IdRightArrow:
                    Intent intent1=new Intent(SparePartReceiptActivity.this, SubServiceActivity.class);
