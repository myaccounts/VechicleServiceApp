...
public class VechicleMasterActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Intent intent=new Intent(VechicleMasterActivity.this, SparePartMasterActivity.class);
        ...
        try{
            switch (v.getId())
            {
                case R.id.IdLeftArrow:
                    Intent intent=new Intent(VechicleMasterActivity.this, ServiceMasterActivity.class);
                    startActivity(intent);
                    break;
                case R.id.IdRightArrow:
                    Intent intent1=new Intent(VechicleMasterActivity.this, SparePartMasterActivity.class);
