...
public class VehicleHistoryAdapter extends RecyclerView.Adapter<VehicleHistoryAdapter.Itemholder> {
    ...
    private String imageURI = "",local_capture_image1=null,local_signature_image1=null,requestName,signature_image1=null,capture_image1=null;
    ...
    public VehicleHistoryAdapter(ArrayList<JobCardHistory> items, OnItemClickListener listener){
        this.jobCardHistoryArrayList = items;
        this.mItemClickListener = listener;

    }
    public VehicleHistoryAdapter(Context context, int jobcard_history_row_item, ArrayList<JobCardHistory> jobCardHistoryArrayList,String vehicleNo) {
    ...
    @NonNull
    @Override
    public VehicleHistoryAdapter.Itemholder onCreateViewHolder(ViewGroup parent, int i) {
        View view= LayoutInflater.from(context).inflate(layout_rowitems,parent,false);
        VehicleHistoryAdapter.Itemholder itemViewHolder=new VehicleHistoryAdapter.Itemholder(view);
        return itemViewHolder;
    }

    @Override
    public void onBindViewHolder(VehicleHistoryAdapter.Itemholder holder, int position) {
        ...
        holder.IdTechnician.setText(String.valueOf(jobCardHistory.getTechnician()));
        holder.IdKmReading.setText(String.valueOf(jobCardHistory.getKmReading()));
    }
    ...
    public class Itemholder extends RecyclerView.ViewHolder implements View.OnClickListener{
        private TextView IdSNoTv,IdJobCardNoTv,IdDateTv,IdVehicleNoTv,IdTimeInTv,IdTimeOutTv,IdSparePartsTv,IdServChargeTv,IdStatusTv,IdTechnician,IdKmReading;
        public View itemView;
        public LinearLayout kmstechnician_lyt;
        public Itemholder(View itemView) {
            ...
            IdTechnician = (TextView)itemView.findViewById(R.id.IdTechnician);
            IdKmReading = (TextView)itemView.findViewById(R.id.IdKmReading);
            kmstechnician_lyt = (LinearLayout)itemView.findViewById(R.id.kmstechnician_lyt);
            kmstechnician_lyt.setVisibility(View.VISIBLE);
...
//                                    imageURI = local_signature_image1;
        ...
        /*try {
            ...
            if (cursor != null) {
                if (cursor.getCount() > 0) {
                    cursor.moveToFirst();
                    vehicleIdValue = cursor.getString(cursor.getColumnIndex(InfDbSpecs.VehicleNo));
                    filepath = cursor.getString(cursor.getColumnIndex(InfDbSpecs.Filepath));
        ...
        /*if(vehicleNo.equals(vehicleIdValue)){
